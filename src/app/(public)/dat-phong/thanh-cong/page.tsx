  ...
  return (
    <div className="px-4 py-20 sm:px-6 lg:px-10 lg:py-28">
      <div className="mx-auto max-w-lg text-center">
        ...
        <h1 className="mt-8 text-2xl h-section text-ink lg:text-3xl">
          {t('success.title')}
        </h1>
        ...
        <div className="mt-10 bg-sand px-8 py-10">
          ...
          <p className="mt-4 text-[26px] tracking-[0.06em] text-brand-deep lg:text-3xl">
            {code}
          </p>
          <p className="mt-5 body-text text-ink-soft">{t('success.saveCode')}</p>
        </div>
