    ...
    <footer className="bg-night text-white/70">
      <div className="mx-auto max-w-[1400px] px-6 py-16 lg:px-10 lg:py-20">
        ...
        <div className="border-b border-white/10 pb-12 text-center">
          <span className="block text-2xl font-extralight uppercase tracking-[0.3em] text-white lg:text-3xl">
            Long Hải
          </span>
          <span className="mt-2 block text-[8px] uppercase tracking-[0.42em] text-white/40 lg:text-[9px]">
            — {t('ui.hotelSub')} —
          </span>
          <p className="mx-auto mt-6 max-w-md text-xs font-light leading-relaxed text-white/50">
            {t('hero.tagline')}
          </p>
          <SocialIcons
            className="mt-7 justify-center gap-5 text-white/45"
        ...
        <div className="grid grid-cols-1 gap-12 py-12 sm:grid-cols-3">
          <div>
            <h3 className="mb-5 text-[10px] uppercase tracking-[0.24em] text-white">
              {t('ui.contactUs')}
            </h3>
        ...
        <div className="border-t border-white/10 pt-8 text-center text-[9px] uppercase tracking-[0.2em] text-white/40">
