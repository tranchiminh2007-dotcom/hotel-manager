...
import { NAV_ITEMS, HOTEL_CONFIG } from '@/lib/constants'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href={`tel:${HOTEL_CONFIG.phone}`} className="flex items-center gap-1 text-sm text-gray-600">
              <Phone className="h-4 w-4" />
              {HOTEL_CONFIG.phone}
            </a>
            <Link href="/dat-phong">
              <Button size="sm">Đặt phòng ngay</Button>
            </Link>
          </div>
          ...
          <div className="px-4 py-3 space-y-1">
            ...
            <div className="pt-3 border-t border-gray-100">
              <Link href="/dat-phong" onClick={() => setMobileOpen(false)}>
                <Button className="w-full">Đặt phòng ngay</Button>
              </Link>
            </div>
          </div>
        </div>
